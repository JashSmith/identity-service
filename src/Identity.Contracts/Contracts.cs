...
public sealed record PermissionManifestMessage(string ServiceId, string ServiceName, string Version, string Environment, IReadOnlyCollection<PermissionMessage> Permissions, string ManifestVersion, Guid CorrelationId, DateTimeOffset PublishedAt);
