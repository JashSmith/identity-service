...
// Key management
builder.Services.Configure<Identity.Application.KeyManagementOptions>(builder.Configuration.GetSection("Identity:KeyManagement"));
...
builder.Services.AddSingleton(sp => sp.GetRequiredService<Microsoft.Extensions.Options.IOptions<Identity.Application.KeyManagementOptions>>().Value);
builder.Services.AddSingleton<Identity.Application.IKeyGenerationService, Identity.Infrastructure.RsaKeyGenerationService>();
builder.Services.AddSingleton<Identity.Application.IKeyRetirementSafety, Identity.Infrastructure.KeyRetirementSafety>();
builder.Services.AddSingleton<Identity.Application.IKeyRotationLock, Identity.Infrastructure.Redis.InMemoryKeyRotationLock>();
...
builder.Services.AddSingleton<Identity.Application.ISigningKeyVault>(sp => sp.GetRequiredService<Identity.Infrastructure.Vault.VaultSigningKeyStore>());
builder.Services.AddHttpClient<Identity.Infrastructure.Keycloak.KeycloakKeyManager>();
builder.Services.AddSingleton<Identity.Application.IKeycloakKeyManager>(sp => sp.GetRequiredService<Identity.Infrastructure.Keycloak.KeycloakKeyManager>());
...
builder.Services.AddScoped<Identity.Application.IKeyLifecycleRepository, Identity.Persistence.KeyManagement.EfKeyLifecycleRepository>();
